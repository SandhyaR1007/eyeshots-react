  ...
  return (
    <main className=" flex justify-between items-center py-4 my-5 font-josephin relative">
      <section className="max-w-xl mx-auto sm:mx-0  sm:w-2/3 p-3  ">
        <h1 className="text-8xl sm:text-6xl md:text-7xl font-semibold  py-3">
          Glasses
          <br />& Lens
        </h1>
        ...
        <section className="flex items-center">
          <button className="py-2 px-4 bg-gray-900 text-sm text-gray-100 rounded-lg hover:bg-gray-800">
            Start Shopping
          </button>
